 ...
 * @ORM\Entity(repositoryClass="Jc\ObdulioBundle\Repository\SiembraRepository")
 */
class Siembra
{
    /**
     ...
     * @var int
     *
     * @ORM\Column(name="anno", type="integer", unique=true)
     */
    private $anno;
    /**
     * @ORM\ManyToOne(targetEntity="Producto", inversedBy="siembra")
     * @ORM\JoinColumn(name="fk_producto", referencedColumnName="id")
     */
    private $fkProducto;
    /**
     * @ORM\ManyToOne(targetEntity="Unidad", inversedBy="siembra")
